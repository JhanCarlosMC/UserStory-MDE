...
public class ConcretaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ConcretaPackage.WORKSPACE: {
				Workspace workspace = (Workspace)theEObject;
				T result = caseWorkspace(workspace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConcretaPackage.USER_STORY: {
				UserStory userStory = (UserStory)theEObject;
				T result = caseUserStory(userStory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConcretaPackage.COMO: {
				Como como = (Como)theEObject;
				T result = caseComo(como);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConcretaPackage.QUIERO: {
				Quiero quiero = (Quiero)theEObject;
				T result = caseQuiero(quiero);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConcretaPackage.PARA: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Como</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Como</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComo(Como object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Quiero</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Quiero</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQuiero(Quiero object) {
		return null;
	}
