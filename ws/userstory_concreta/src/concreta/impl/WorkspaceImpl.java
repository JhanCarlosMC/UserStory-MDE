 ...
 * </p>
 * <ul>
 *   <li>{@link concreta.impl.WorkspaceImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link concreta.impl.WorkspaceImpl#getListUserStorys <em>List User Storys</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkspaceImpl extends EObjectImpl implements Workspace {
	...
	protected EClass eStaticClass() {
		return ConcretaPackage.Literals.WORKSPACE;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretaPackage.WORKSPACE__NOMBRE, oldNombre, nombre));
	}
	...
	public EList<UserStory> getListUserStorys() {
		if (listUserStorys == null) {
			listUserStorys = new EObjectContainmentEList<UserStory>(UserStory.class, this, ConcretaPackage.WORKSPACE__LIST_USER_STORYS);
		}
