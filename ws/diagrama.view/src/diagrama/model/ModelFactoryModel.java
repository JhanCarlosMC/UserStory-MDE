...
public class ModelFactoryModel {
	...
	public void generarTemplate(){
		modelFactoryAbstracta = cargarAbstracta();
		
//		TransformacionTemplate transformacionTemplate = new TransformacionTemplate(modelFactoryAbstracta);
//		transformacionTemplate.crearPDF();
		TransformacionM2D transformacionM2D = new TransformacionM2D(modelFactoryAbstracta);
		transformacionM2D.crearPDF();
	}
