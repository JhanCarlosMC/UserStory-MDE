	...
	public String crearPDF() {
		...
		try {
			...
			for (UserStory userStory : modelFactoryAbstracta.getListUserStorys()) {
				...
				numeroText.add(" " + userStory.getIdentificador()); // Linea para añadir más información al texto que lleva la celda, aquí se añade
				...
				usuarioText.add(" " + userStory.getTheComo().getDescripcion());// Linea para añadir más información al texto que lleva la celda, aquí se añade
									// la info que viene de la abstracta
				...
				nombreHUText.add(" " + userStory.getNombre());// Linea para añadir más información al texto que lleva la celda, aquí se añade
										// la info que viene de la abstracta
				...
				prioridadText.add(" " + userStory.getPrioridad());// Linea para añadir más información al texto que lleva la celda, aquí se añade
										// la info que viene de la abstracta
				...
				riesgoText.add(" " + userStory.getRiesgo());// Linea para añadir más información al texto que lleva la celda, aquí se añade
									// la info que viene de la abstracta
				...
				puntosText.add(" " + userStory.getEstimacion());// Linea para añadir más información al texto que lleva la celda, aquí se añade
									// la info que viene de la abstracta
				...
				interracionText.add(" " + userStory.getIteracion());// Linea para añadir más información al texto que lleva la celda, aquí se añade
										// la info que viene de la abstracta
				...
				responsableText.add(" " + userStory.getResponsable());// Linea para añadir más información al texto que lleva la celda, aquí se añade
										// la info que viene de la abstracta
				...
				descripcionText.add(" " + userStory.getTheQuiero());// Linea para añadir más información al texto que lleva la celda, aquí se añade
										// la info que viene de la abstracta
				...
				validacionText.add(" " + userStory.getThePara());// Linea para añadir más información al texto que lleva la celda, aquí se añade
										// la info que viene de la abstracta
