 ...
 * @generated
 */
public class ParaDescripcionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ParaDescripcionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Para_3003, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ParaDescripcionEditPart.VISUAL_ID));
		}
		return parser;
	}
