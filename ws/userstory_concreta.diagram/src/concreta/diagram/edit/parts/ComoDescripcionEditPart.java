 ...
 * @generated
 */
public class ComoDescripcionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ComoDescripcionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Como_3001, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ComoDescripcionEditPart.VISUAL_ID));
		}
		return parser;
	}
