 ...
 * @generated
 */
public class ParaNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ParaNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Para_3003, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ParaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
