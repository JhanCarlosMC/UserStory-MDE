 ...
 * @generated
 */
public class UserStoryNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UserStoryNombreEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.UserStory_2001, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.UserStoryNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
