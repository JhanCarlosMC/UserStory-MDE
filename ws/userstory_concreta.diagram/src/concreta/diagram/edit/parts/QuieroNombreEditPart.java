 ...
 * @generated
 */
public class QuieroNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public QuieroNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Quiero_3002, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.QuieroNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
