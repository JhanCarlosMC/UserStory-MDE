 ...
 * @generated
 */
public class ComoNombreEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ComoNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Como_3001, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.ComoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
