 ...
 * @generated
 */
public class QuieroDescripcionEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public QuieroDescripcionEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcretaParserProvider.getParser(ConcretaElementTypes.Quiero_3002, getParserElement(),
					ConcretaVisualIDRegistry.getType(concreta.diagram.edit.parts.QuieroDescripcionEditPart.VISUAL_ID));
		}
		return parser;
	}
