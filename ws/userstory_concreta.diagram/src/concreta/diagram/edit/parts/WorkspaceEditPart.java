...
import concreta.diagram.edit.policies.WorkspaceCanonicalEditPolicy;
import concreta.diagram.edit.policies.WorkspaceItemSemanticEditPolicy;
...
public class WorkspaceEditPart extends DiagramEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new WorkspaceItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new WorkspaceCanonicalEditPolicy());
