...
/**
 * This is the item provider adapter for a {@link abstracta.UserStory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserStoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AbstractaPackage.Literals.USER_STORY__NOMBRE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AbstractaPackage.Literals.USER_STORY__IDENTIFICADOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AbstractaPackage.Literals.USER_STORY__ESTIMACION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AbstractaPackage.Literals.USER_STORY__PRIORIDAD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AbstractaPackage.Literals.USER_STORY__RIESGO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AbstractaPackage.Literals.USER_STORY__RESPONSABLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AbstractaPackage.Literals.USER_STORY__ITERACION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AbstractaPackage.Literals.USER_STORY__THE_COMO);
			childrenFeatures.add(AbstractaPackage.Literals.USER_STORY__THE_QUIERO);
			childrenFeatures.add(AbstractaPackage.Literals.USER_STORY__THE_PARA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AbstractaPackage.Literals.USER_STORY__THE_COMO,
				 AbstractaFactory.eINSTANCE.createComo()));

		newChildDescriptors.add
			(createChildParameter
				(AbstractaPackage.Literals.USER_STORY__THE_QUIERO,
				 AbstractaFactory.eINSTANCE.createQuiero()));

		newChildDescriptors.add
			(createChildParameter
				(AbstractaPackage.Literals.USER_STORY__THE_PARA,
				 AbstractaFactory.eINSTANCE.createPara()));
	}
