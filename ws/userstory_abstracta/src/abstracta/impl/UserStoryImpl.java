 ...
 * </p>
 * <ul>
 *   <li>{@link abstracta.impl.UserStoryImpl#getNombre <em>Nombre</em>}</li>
 *   <li>{@link abstracta.impl.UserStoryImpl#getIdentificador <em>Identificador</em>}</li>
 *   <li>{@link abstracta.impl.UserStoryImpl#getEstimacion <em>Estimacion</em>}</li>
 *   <li>{@link abstracta.impl.UserStoryImpl#getPrioridad <em>Prioridad</em>}</li>
 *   <li>{@link abstracta.impl.UserStoryImpl#getRiesgo <em>Riesgo</em>}</li>
 *   <li>{@link abstracta.impl.UserStoryImpl#getResponsable <em>Responsable</em>}</li>
 *   <li>{@link abstracta.impl.UserStoryImpl#getIteracion <em>Iteracion</em>}</li>
 *   <li>{@link abstracta.impl.UserStoryImpl#getTheComo <em>The Como</em>}</li>
 *   <li>{@link abstracta.impl.UserStoryImpl#getTheQuiero <em>The Quiero</em>}</li>
 *   <li>{@link abstracta.impl.UserStoryImpl#getThePara <em>The Para</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserStoryImpl extends EObjectImpl implements UserStory {
	...
	protected EClass eStaticClass() {
		return AbstractaPackage.Literals.USER_STORY;
	}
	...
	public void setNombre(String newNombre) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__NOMBRE, oldNombre, nombre));
	}
	...
	public void setIdentificador(String newIdentificador) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__IDENTIFICADOR, oldIdentificador, identificador));
	}
	...
	public void setEstimacion(String newEstimacion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__ESTIMACION, oldEstimacion, estimacion));
	}
	...
	public void setPrioridad(String newPrioridad) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__PRIORIDAD, oldPrioridad, prioridad));
	}
	...
	public void setRiesgo(String newRiesgo) {
		...
		riesgo = newRiesgo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__RIESGO, oldRiesgo, riesgo));
	}
	...
	public void setResponsable(String newResponsable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__RESPONSABLE, oldResponsable, responsable));
	}
	...
	public void setIteracion(String newIteracion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__ITERACION, oldIteracion, iteracion));
	}
	...
	public NotificationChain basicSetTheComo(Como newTheComo, NotificationChain msgs) {
		...
		theComo = newTheComo;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__THE_COMO, oldTheComo, newTheComo);
	...
	public void setTheComo(Como newTheComo) {
		if (newTheComo != theComo) {
			...
			if (theComo != null)
				msgs = ((InternalEObject)theComo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AbstractaPackage.USER_STORY__THE_COMO, null, msgs);
			if (newTheComo != null)
				msgs = ((InternalEObject)newTheComo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AbstractaPackage.USER_STORY__THE_COMO, null, msgs);
			msgs = basicSetTheComo(newTheComo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__THE_COMO, newTheComo, newTheComo));
	}
	...
	public NotificationChain basicSetTheQuiero(Quiero newTheQuiero, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__THE_QUIERO, oldTheQuiero, newTheQuiero);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTheQuiero(Quiero newTheQuiero) {
		if (newTheQuiero != theQuiero) {
			NotificationChain msgs = null;
			if (theQuiero != null)
				msgs = ((InternalEObject)theQuiero).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AbstractaPackage.USER_STORY__THE_QUIERO, null, msgs);
			if (newTheQuiero != null)
				msgs = ((InternalEObject)newTheQuiero).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AbstractaPackage.USER_STORY__THE_QUIERO, null, msgs);
			msgs = basicSetTheQuiero(newTheQuiero, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__THE_QUIERO, newTheQuiero, newTheQuiero));
	}
	...
	public NotificationChain basicSetThePara(Para newThePara, NotificationChain msgs) {
		...
		thePara = newThePara;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__THE_PARA, oldThePara, newThePara);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setThePara(Para newThePara) {
		if (newThePara != thePara) {
			NotificationChain msgs = null;
			if (thePara != null)
				msgs = ((InternalEObject)thePara).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AbstractaPackage.USER_STORY__THE_PARA, null, msgs);
			if (newThePara != null)
				msgs = ((InternalEObject)newThePara).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AbstractaPackage.USER_STORY__THE_PARA, null, msgs);
			msgs = basicSetThePara(newThePara, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractaPackage.USER_STORY__THE_PARA, newThePara, newThePara));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AbstractaPackage.USER_STORY__THE_COMO:
				return basicSetTheComo(null, msgs);
			case AbstractaPackage.USER_STORY__THE_QUIERO:
				return basicSetTheQuiero(null, msgs);
			case AbstractaPackage.USER_STORY__THE_PARA:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AbstractaPackage.USER_STORY__NOMBRE:
				return getNombre();
			case AbstractaPackage.USER_STORY__IDENTIFICADOR:
				return getIdentificador();
			case AbstractaPackage.USER_STORY__ESTIMACION:
				return getEstimacion();
			case AbstractaPackage.USER_STORY__PRIORIDAD:
				return getPrioridad();
			case AbstractaPackage.USER_STORY__RIESGO:
				return getRiesgo();
			case AbstractaPackage.USER_STORY__RESPONSABLE:
				return getResponsable();
			case AbstractaPackage.USER_STORY__ITERACION:
				return getIteracion();
			case AbstractaPackage.USER_STORY__THE_COMO:
				return getTheComo();
			case AbstractaPackage.USER_STORY__THE_QUIERO:
